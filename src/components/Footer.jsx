...
const Footer = () => {
  return (
    <div className=" bg-[#0a1a25] text-white rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">SmartPharm</h1>
          <p className=" text-sm">
      ...
      <div>
        <p className=" text-center py-4">
          ...
          <span className=" text-hoverColor"> Smartpharmteam</span> | All
          rights reserved
        </p>
      </div>
    </div>
